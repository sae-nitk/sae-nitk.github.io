  ...
  return (
    ...
    >
      ...
      <div className="lg:w-2/3 p-6 lg:p-8 flex flex-col justify-between">
        <div>
          <div className="mb-4">
            <h3 className="text-2xl md:text-3xl font-bold mb-1" style={{ color: SAE_BLUE }}>
              {name}
            </h3>
            <p className="text-lg md:text-xl font-semibold mb-2" style={{ color: SAE_RED }}>
              {role}
            </p>
          ...
          <div className="relative my-6">
            <div className="absolute -top-4 -left-4 text-7xl opacity-10" style={{ color: SAE_BLUE }}>"</div>
            <p className="relative z-10 text-gray-700 text-lg pl-6 border-l-4 italic leading-relaxed" style={{ borderColor: SAE_RED }}>
              {message}
            </p>
          </div>
        </div>
