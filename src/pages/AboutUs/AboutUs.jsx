    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 md:mb-20" data-aos="fade-down">
          ...
          >
            <span style={{ color: SAE_RED }}>
              {aboutUsData.title.split(" ")[0]}
            </span>{" "}
            <span style={{ color: SAE_BLUE }}>
              {aboutUsData.title.split(" ")[1]}
            </span>
          </motion.h1>
          ...
          {aboutUsData.quotes.map((quote, index) => (
            <motion.div
              ...
              style={{
                ...
                borderTop: `1px solid ${
                  index % 2 === 0 ? SAE_BLUE + "20" : SAE_RED + "20"
                }`,
              }}
            ...
            >
              ...
              <p className="text-gray-700 text-lg leading-relaxed pl-6 mt-4">
                {quote.text}
              </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                To cultivate automotive engineering excellence through hands-on
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed">
                To be the premier student organization developing future
                mobility leaders through technical education and competitive
                experiences.
              </p>
            </div>
          </div>
